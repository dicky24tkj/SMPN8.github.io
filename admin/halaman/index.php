...
<body>
<p><a href="index.php?page=halaman&amp;process=create">Tambah</a></p>
...
<img style="margin:10px" src="foto/<?php echo $row_index['foto_halaman']; ?>" width="200" class="img-thumbnail pull-left"  />
    	<h3><a href="index.php?page=halaman&process=detail&recordID=<?php echo $row_index['id_halaman']; ?>"> <?php echo $row_index['nama_halaman']; ?>&nbsp; </a></h3><br />
 
     <?php echo $row_index['isi_halaman']; ?>&nbsp;  <br /> 
     <div class="clearfix"></div>
     
     <a href="index.php?page=halaman&process=update&id_halaman=<?php echo $row_index['id_halaman']; ?>" class="btn btn-xs btn-info">Edit</a>   <a class="btn btn-xs btn-danger" href="index.php?page=halaman&process=delete&id_halaman=<?php echo $row_index['id_halaman']; ?>?id_halaman=<?php echo $row_index['id_halaman']; ?>?id_halaman=<?php echo $row_index['id_halaman']; ?>?id_halaman=<?php echo $row_index['id_halaman']; ?>?id_halaman=<?php echo $row_index['id_halaman']; ?>?id_halaman=<?php echo $row_index['id_halaman']; ?>?id_halaman=<?php echo $row_index['id_halaman']; ?>">Hapus</a> 
     </div> 
