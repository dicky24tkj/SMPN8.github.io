...
$query_DetailRS1 = sprintf("SELECT * FROM katagori_buku WHERE id_katagori_buku = %s", GetSQLValueString($colname_DetailRS1, "int"));
...
<table border="1" align="center">
  ...
  <tr>
    <td>nama_katagori</td>
    <td><?php echo $row_DetailRS1['nama_katagori']; ?></td>
  </tr>
</table>
  </div>
 </div>
