...
$query_DetailRS1 = sprintf("SELECT * FROM peminjaman WHERE id_peminjaman = %s", GetSQLValueString($colname_DetailRS1, "int"));
...
<table border="1" align="center">
  <tr>
    <td>id_peminjaman</td>
    <td><?php echo $row_DetailRS1['id_peminjaman']; ?></td>
  </tr>
  <tr>
    <td>kode_buku</td>
  ...
  <tr>
    ...
    <td><?php echo $row_DetailRS1['tanggal_peminjaman']; ?></td>
  </tr>
  <tr>
    <td>tanggal_pengembalian</td>
    <td><?php echo $row_DetailRS1['tanggal_pengembalian']; ?></td>
  </tr>
</table>
  </div>
 </div>
